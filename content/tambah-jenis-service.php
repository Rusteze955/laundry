...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['save'])) {
        ...
        header("location:?page=jenis-service&ubah=berhasil");
    }
} else {
    if (isset($_POST['save'])) {
        $name = $_POST['service_name'];
        ...
        header("location:?page=jenis-service&tambah=berhasil");
    }
}
?>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input name="customer_name" type="text" class="form-control" value="<?php echo isset($_GET['edit']) ? $row['service_name'] : '' ?>" placeholder="Enter your name service" required>
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Price</label>
                            <input name="phone" type="text" class="form-control" value="<?php echo isset($_GET['edit']) ? $row['price'] : '' ?>" placeholder="Enter your price" required>
                        </div>
                        <div class="mb-3">
